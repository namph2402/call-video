...
module.exports = {
    ...
    server: {
        listen: {
            // app listen on
            ip: '0.0.0.0',
            port: process.env.PORT_SERVER || 3010,
        },
        ssl: {
            // ssl/README.md
            cert: '../ssl/cert.pem',
        ...
        recording: {
            ...
            */
            enabled: true,
            endpoint: process.env.RECORDING_ENDPOINT || '', // Change the URL if you want to save the recording to a different server or cloud service (http://localhost:8080), otherwise leave it as is (empty).
            dir: 'rec',
        },
        rtmp: {
            /*
    ...
    api: {
        ...
        keySecret: process.env.API_KEYSECRET || 'default_secret',
    ...
    oidc: {
        ...
        */
        ...
        config: {
            ...
            baseURL: `http://localhost:${process.env.PORT_SERVER ? process.env.PORT_SERVER : 3010}`, // https://sfu.mirotalk.com
            clientID: 'clientID',
