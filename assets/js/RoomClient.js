...
const html = {
    ...
    audioOn: 'bi bi-mic-fill',
    audioOff: 'bi bi-mic-mute-fill',
    videoOn: 'bi bi-camera-video-fill',
    videoOff: 'bi bi-camera-video-off-fill',
    userName: 'username',
...
const icons = {
    ...
    up: '<i class="bi bi-gear-fill"></i>',
    down: '<i class="bi bi-gear-fill"></i>',
};

const image = {
    about: '/' + drupalSettings.callVideo.modulePath + 'images/mirotalk-logo.gif',
    avatar: '/' + drupalSettings.callVideo.modulePath + 'images/mirotalksfu-logo.png',
    audio: '/' + drupalSettings.callVideo.modulePath + 'images/audio.gif',
    poster: '/' + drupalSettings.callVideo.modulePath + 'images/loader.gif',
    rec: '/' + drupalSettings.callVideo.modulePath + 'images/rec.png',
    recording: '/' + drupalSettings.callVideo.modulePath + 'images/recording.png',
    delete: '/' + drupalSettings.callVideo.modulePath + 'images/delete.png',
    locked: '/' + drupalSettings.callVideo.modulePath + 'images/locked.png',
    mute: '/' + drupalSettings.callVideo.modulePath + 'images/mute.png',
    hide: '/' + drupalSettings.callVideo.modulePath + 'images/hide.png',
    stop: '/' + drupalSettings.callVideo.modulePath + 'images/stop.png',
    unmute: '/' + drupalSettings.callVideo.modulePath + 'images/unmute.png',
    unhide: '/' + drupalSettings.callVideo.modulePath + 'images/unhide.png',
    start: '/' + drupalSettings.callVideo.modulePath + 'images/start.png',
    users: '/' + drupalSettings.callVideo.modulePath + 'images/participants.png',
    user: '/' + drupalSettings.callVideo.modulePath + 'images/participant.png',
    username: '/' + drupalSettings.callVideo.modulePath + 'images/user.png',
    videoShare: '/' + drupalSettings.callVideo.modulePath + 'images/video-share.png',
    message: '/' + drupalSettings.callVideo.modulePath + 'images/message.png',
    share: '/' + drupalSettings.callVideo.modulePath + 'images/share.png',
    exit: '/' + drupalSettings.callVideo.modulePath + 'images/exit.png',
    feedback: '/' + drupalSettings.callVideo.modulePath + 'images/feedback.png',
    lobby: '/' + drupalSettings.callVideo.modulePath + 'images/lobby.png',
    email: '/' + drupalSettings.callVideo.modulePath + 'images/email.png',
    chatgpt: '/' + drupalSettings.callVideo.modulePath + 'images/chatgpt.png',
    all: '/' + drupalSettings.callVideo.modulePath + 'images/all.png',
    forbidden: '/' + drupalSettings.callVideo.modulePath + 'images/forbidden.png',
    broadcasting: '/' + drupalSettings.callVideo.modulePath + 'images/broadcasting.png',
    geolocation: '/' + drupalSettings.callVideo.modulePath + 'images/geolocation.png',
    network: '/' + drupalSettings.callVideo.modulePath + 'images/network.gif',
    rtmp: '/' + drupalSettings.callVideo.modulePath + 'images/rtmp.png',
    save: '/' + drupalSettings.callVideo.modulePath + 'images/save.png',
};
...
class RoomClient {
    ...
    async produce(type, deviceId = null, swapCamera = false, init = false) {
        ...
        try {
            ...
            if (!audio) {
                ...
                if (!isInitVideoMirror && elem.classList.contains('mirror123')) {
                    elem.classList.remove('mirror123');
                }
    ...
    toggleVideoPin(position) {
        ...
        switch (position) {
            ...
            case 'vertical':
                ...
                this.videoMediaContainer.style.left = '75%';
                break;
            case 'horizontal':
                this.videoPinMediaContainer.style.top = 0;
                this.videoPinMediaContainer.style.width = '100%';
        ...
        for (let chunkIndex = 0; chunkIndex < totalChunks; chunkIndex++) {
            ...
            try {
                const response = await axios.post(
                    `${this.recording.recSyncServerEndpoint}?fileName=` + rc.recServerFileName,
                    chunk,
                    {
                        headers: {
    ...
    startRendering() {
        ...
        this.canvasAIElement.parentElement.style.background = `${VideoAI.background}`;
